...
def hilldecrypt(encrypted_msg,C):
    # Ask for keyword and get encryption matrix
...
if __name__ == "__main__":
    C = make_key(7,11,8,11)
    if C!=None:
        msg = input("Message: ")
        encrypted_msg = encrypt(msg,C)
        print("le message crypti : "+str(encrypted_msg))
        decrypted_msg = decrypt(encrypted_msg,C)
        print("le message decrypti : "+str(decrypted_msg))
